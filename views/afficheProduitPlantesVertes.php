...
if (isset($_POST['recherche'])) {
    ...
    foreach ($objProduitFLeuries->recherche("1", $recherche) as $res) {
        ?>
        <div class="Produits">
    ...
    if (isset($_POST['trierButton'])) {
        if ($_POST['trier'] == 'PrixCroissant') {
            ...
            foreach ($objProduitFLeuries->afficheProduitFiltres("1", "ORDER BY prixProduit ASC") as $res) {
                ?>
                <div class="Produits">
                    <a href="PlantesFleuris-<?php echo $res['idProduit']?>">
                        <div class="Images_Produit" style="background-image: url('./images/images_produits/<?php echo $res['nameProduit']?>.jpg'); width: 100%; height: 200px; background-size: cover;"></div>
            ...
            echo "<div class='Taille_Liste_Produit' style=' height: 2050px; width: 100%;'>";
            foreach ($objProduitFLeuries->afficheProduitFiltres("1", "ORDER BY prixProduit DESC") as $res) {
                ?>
                <div class="Produits">
                    <a href="PlantesFleuris-<?php echo $res['idProduit']?>">
                        <div class="Images_Produit" style="background-image: url('./images/images_produits/<?php echo $res['nameProduit']?>.jpg'); width: 100%; height: 200px; background-size: cover;"></div>
        ...
        echo "<div class='Taille_Liste_Produit' style=' height: 2050px; width: 100%;'>";
        foreach ($objProduitFLeuries->afficheProduit("1") as $res) {
            ?>
            <div class="Produits">
                <a href="PlantesFleuris-<?php echo $res['idProduit']?>">
